...
A simple loan interest calculator demonstrates basic math using javascript functions.

<h1 id="features">Key Features</h1>

+ Caculate monthly loan payments
+ Set interest amount
+ Set life of loan
+ Responsive Design
...
Here is a working live demonstration: https://mrblach.github.io/loan-calculator/
...
If you find a bug (the website couldn't handle the query and / or gave undesired results), kindly open an issue [here](https://github.com/MRBlach/loan-calculator/issues/new) by including your search query and the expected result.

If you'd like to request a new function, feel free to do so by opening an issue [here](https://github.com/MRBlach/loan-calculator/issues/new). Please include sample queries and their corresponding results.
...
+ Thanks to **Mozilla** for supplying the [free javascript Math object documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math)
+ Thanks to **Bootstrap** for providing the [free styling documentation](https://getbootstrap.com/docs/5.0/getting-started/introduction/)

### You may also like..

+ [Github Finder](https://github.com/MRBlach/github-finder "Github Finder") - A Github API project